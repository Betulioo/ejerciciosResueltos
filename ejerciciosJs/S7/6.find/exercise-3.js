...
const findedAlien = aliens.find(alien => alien.name.toLowerCase() === 'cucushumushu');
const findedMutation = mutations.find(mutation => mutation.name.toLowerCase() === 'porompompero');
findedAlien.mutation = findedMutation;

console.log(findedAlien);